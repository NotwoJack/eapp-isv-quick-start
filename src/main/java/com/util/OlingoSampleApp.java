...
public class OlingoSampleApp {
    ...
    public static void readAPI(String serviceUrl) throws IOException, ODataException {
    ...
    public static void readAPI2(String serviceUrl) throws IOException, ODataException {
        OlingoSampleApp app = new OlingoSampleApp();
...
//    String usedFormat = APPLICATION_ATOM_XML;
    ...
    public void generateSampleData(String serviceUrl) throws MalformedURLException, IOException {
        ...
        print(url);
        HttpURLConnection connection = initializeConnection(url, APPLICATION_XML, HTTP_METHOD_GET);
//        String content = "genSampleData=true";
//        connection.getOutputStream().write(content.getBytes());
//        connection.connect();
//        //会报身份验证
//        //再次连接
//        String str_param_body = "userName=jk&password=raedu123";
...
//        params.append("username=").append("jk").append("&").append("password=").append("raedu123");
...
//        print(absolutUri);
//        URL url = new URL("http://rajyj.edu.cn%5Cjk:raedu123@"+absolutUri);

// or Method 2 : authentication via System.setProperty()
        System.setProperty("http.auth.ntlm.domain", "rajyj.edu.cn");
        System.setProperty("jcifs.smb.client.domain", "rajyj.edu.cn");
        System.setProperty("jcifs.smb.client.username", "jk");
        System.setProperty("jcifs.smb.client.password", "raedu123");
        System.setProperty("jcifs.netbios.hostname", "172.100.250.61");
