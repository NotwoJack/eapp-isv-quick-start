...
//        app.perform("http://172.100.250.61:8080/cars.svc");
//    }
//
//    @Test
//    public void test(){
//        final Edm edm = getClient().getRetrieveRequestFactory().getMetadataRequest("http://172.100.250.62/Citrix/Monitor/OData/v4/Data/Machines").execute().getBody();
